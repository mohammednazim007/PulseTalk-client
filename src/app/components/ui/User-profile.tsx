...
const UserProfile = ({ currentUser, isTimeAvailable }: UserProfileProps) => {
  return (
    <div className="flex items-center gap-3 p-[2px] rounded-lg cursor-pointer">
      {/* Avatar Section */}
      <div className="w-8 h-8 rounded-full overflow-hidden border-2 border-green-500/80 flex-shrink-0">
        <Image
          width={48}
          height={48}
          priority={true}
