                              ...
                              <div>
                                ...
                                <div className="relative">
                                  ...
                                  <input
                                    ...
                                    readOnly
                                    value={currentUser?.user?.email || ""}
                                    className="w-full pl-11 pr-4 py-2.5 bg-slate-900/50 border border-slate-800 rounded-xl text-slate-500 cursor-not-allowed outline-none"
                                  />
                                  <FaLock className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-600 w-3 h-3" />
                                </div>
                              </div>
                              ...
                              <div className="space-y-4">
                                <div className="relative">
                                  <Field
                                    ...
                                    name="currentPassword"
                                    placeholder="Current Password"
                                    className="w-full px-4 py-2.5 bg-slate-900 border border-slate-700 rounded-lg focus:ring-2 focus:ring-indigo-500/50 outline-none text-slate-200 placeholder:text-slate-600"
                                  />
                                  <button
                                    type="button"
                                    onClick={() =>
